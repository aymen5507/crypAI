...
from data_collection import load
from debou.trainer import Trainer
from debou.evaluator import Evaluator
from debou.profit_calc import ProfitCalculator
import pandas as pd
...
from data_collection.creator import create_dataset, preprocess
...
def train(cfg: DictConfig):
    if cfg.load_path is None and cfg.model is None:
        ...
        dataset, profit_calculator = load(cfg.dataset_loader.name, cfg.dataset_loader.train_start_date,
